...
import com.udriving.drivingapi.security.config.JWTUserDetailsFactory;
...
//            new SecurityProperties.User();
    ...
    public String generateAccessToken(UserDetails userDetails) {
        ...
        claims.put(CLAIM_KEY_AUTHORITIES, JacksonUtil.toJSONString(authoritiesToArray(user.getAuthorities())));
